...
```jsx
import { Row, Col, Slider, Switch } from '../../index';
...
class App extends React.Component {
  ...
  constructor() {
    super();
    this.state = { isRtl: false, gutterKey: 1, colCountKey: 2 };
  ...
  render() {
    const { gutterKey, colCountKey, isRtl } = this.state;
    const cols = [];
    ...
    return (
      <div>
        ...
        <div>
          ...
          <Row isRtl={isRtl} gutter={this.gutters[gutterKey]}>
            {cols}
          </Row>
